        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="hover:shadow-xl transition-shadow">
            <CardContent className="p-0">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary mb-3">PRIVATE COACHING</h3>
                ...
                <Button className="w-full bg-primary hover:bg-brand-orange-hover text-primary-foreground font-bold">
                  CHAT WITH A COACH
                </Button>
              </div>
            </CardContent>
          ...
          <Card className="hover:shadow-xl transition-shadow">
            <CardContent className="p-0">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary mb-3">EXPRESS SERVICES</h3>
                <p className="text-foreground mb-4">
          ...
          <Card className="hover:shadow-xl transition-shadow">
            <CardContent className="p-0">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary mb-3">BLUEPRINTS™</h3>
                <p className="text-foreground mb-4">
